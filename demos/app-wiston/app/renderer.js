...
//created by AI
// winston三方库调用按钮
const winstonBtn = document.getElementById('openWinston');
// async三方库调用按钮
const asyncBtn = document.getElementById('openAsync');
//created by AI//
// 每日早报按钮
const zaobaoBtn = document.getElementById('openZaobao');
//created by AI
// 仿bili按钮
const bilibiliBtn = document.getElementById('openBilibili');
//created by AI//
...
// winston三方库调用按钮事件
if (winstonBtn) {
  winstonBtn.addEventListener('click', () => {
    console.log('open-winston button clicked');
    ipcRenderer.send('open-winston');
  });
}
...
if (asyncBtn) {
  asyncBtn.addEventListener('click', () => {
    console.log('open-async button clicked');
    ipcRenderer.send('open-async');
  });
}
//created by AI//
...
if (bilibiliBtn) {
  bilibiliBtn.addEventListener('click', () => {
    console.log('open-bilibili button clicked');
    ipcRenderer.send('open-bilibili');
  });
}
//created by AI//
